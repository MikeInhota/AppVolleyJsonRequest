...
public class MainActivity extends AppCompatActivity {
    TextView nome, tipo, locado;
    Button btnCarregaDados;

    String url_json = "http://127.0.0.1/ProjetoVolleyApi/informacoes.php";
            ...
            public void onClick(View v) {
                JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, url_json, null,
                            ...
                            public void onResponse(JSONObject response) {
                                try {
                                    ...
                                    Toast.makeText(getApplicationContext(),
                                            "Nenhum nome de filme encontrado...",
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(getApplicationContext(),
                                "Erro ao carregar as informações dos filmes",
                                Toast.LENGTH_SHORT).show();
